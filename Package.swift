...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "ASN1Kit", url: "https://github.com/gematik/ASN1Kit.git", .branch("R1.0.9")),
        .package(name: "GemCommonsKit", url: "https://github.com/gematik/ref-GemCommonsKit.git", .branch("R1.1.2"))
    ],
    targets: [
